...
var popUpData = [{
  ...
  description2: 'The ultimate destination for hacking enthusiasts, cybersecurity professionals, and tech aficionados worldwide.',
  ...
  description: 'Health Clinic is modern appointment booking app that empowers you to manage your healthcare with ease. Ditch the phone calls and waiting rooms – Health Clinic gives you the flexibility to schedule appointments anytime, anywhere, straight from your mobile device.',
  description2: 'Health Clinic is modern appointment booking app that empowers you to manage your healthcare with ease. Ditch the phone calls and waiting rooms – Health Clinic gives you the flexibility to schedule appointments anytime, anywhere, straight from your mobile device.',
  ...
  description: ' A mobile web app built with Rails that empowers users to effectively manage their finances. With Smart-Budget, users can create custom categories and track their expenses seamlessly.  By organizing their spending into categories such as groceries, transportation, entertainment, and more, users can gain a comprehensive understanding of their financial habits.',
  description2: 'The app provides an intuitive interface for users to enter their expenses under the relevant categories. Additionally, Smart-Budget automatically calculates and displays the total budget for each category, enabling users to monitor their spending and make informed financial decisions.',
  ...
  description: "Cheapr is a revolutionary app that makes it easy to find nearby stores and service providers offering the best deals on quality goods and services. What's more, it supports businesses that offer the most affordable prices by promoting them to users. The main goal of this project is to encourage a fair price for the goods or services provided.",
  description2: "Cheapr is a revolutionary app that makes it easy to find nearby stores and service providers offering the best deals on quality goods and services. What's more, it supports businesses that offer the most affordable prices by promoting them to users.",
  ...
  description: 'Orbit is a cutting-edge React-based app that unlocks the wonders of space exploration and commercial opportunities. Seamlessly blending scientific research and commercial endeavors, Orbit revolutionizes the way we engage with space.',
  description2: 'Orbit is a cutting-edge React-based app that unlocks the wonders of space exploration and commercial opportunities. Seamlessly blending scientific research and commercial endeavors, Orbit revolutionizes the way we engage with space.',
  ...
  description: "A captivating web application that brings TV shows to life. Explore a vast collection of shows through visually stunning cards, each featuring the show's name and an enticing image. With a simple click, delve into detailed descriptions in elegant pop-up windows.",
  description2: "A captivating web application that brings TV shows to life. Explore a vast collection of shows through visually stunning cards, each featuring the show's name and an enticing image. With a simple click, delve into detailed descriptions in elegant pop-up windows.",
  ...
  description: 'A web app calculator that brings a touch of enchantment to your mathematical journey. Equipped with the power of React, this single-page application seamlessly melds the art of computation with the wonder of technology.',
  description2: 'A web app calculator that brings a touch of enchantment to your mathematical journey. Equipped with the power of React, this single-page application seamlessly melds the art of computation with the wonder of technology.',
...
var noClassAtributes2 = ['img', 'ul', 'li', 'a', 'p', 'p-2'];
Object.keys(keyValuePair3).forEach(function (key) {
...
for (var i = 0; i < popUpData[0].technologies.length; i += 1) {
...
function addSeeMoreListener(btn, x) {
  btn.addEventListener('click', function (event) {
    ...
    for (var _i = 0; _i < popUpData[x].technologies.length; _i += 1) {
      var _li = document.createElement('li');
      _li.innerHTML = popUpData[x].technologies[_i];
      popUpObject.ul.appendChild(_li);
    }
...
for (var x = 1; x <= popUpData.length; x += 1) {
  var btn = document.getElementById("a-".concat(x));
